/**
 * @file sc16is752.h
 * @brief SPI driver for the SC16IS752 Dual UART-to-SPI bridge controller on
 * Holy Grail.
 */
...
#define SC16IS752_REG_THR                                                      \
  0x00 /**< Transmitter Holding Register (W, LCR[7]=0) */
 ...
 *
 * Configures the GPIOs for CD74HC138 control, the MISO buffer isolation
 * control, and sets up the SPI bus parameters.
 *
